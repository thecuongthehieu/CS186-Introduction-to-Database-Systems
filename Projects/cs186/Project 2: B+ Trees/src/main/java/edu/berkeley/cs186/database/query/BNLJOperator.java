...
class BNLJOperator extends JoinOperator {
    ...
    private class BNLJIterator extends JoinIterator {
        ...
        private void fetchNextRecord() {
            ...
            do {
                if (this.rightRecord != null) {
                   if (checkEquals(this.leftRecord, this.rightRecord)) {
        ...
        /**
         * Helper method to check whether or not two record equals
         * @param leftRecord
         * @param rightRecord
         * @return True if equal and otherwise
         */
        private Boolean checkEquals(Record leftRecord, Record rightRecord) {
