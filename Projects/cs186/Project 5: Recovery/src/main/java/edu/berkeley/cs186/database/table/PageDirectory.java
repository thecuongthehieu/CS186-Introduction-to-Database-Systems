...
public class PageDirectory implements HeapFile {
    ...
    public PageDirectory(BufferManager bufferManager, int partNum, long pageNum,
        ...
        // Init capacity for this HeapFile/Table
        this.lockContext.capacity(1 + this.getNumDataPages());
    }
    ...
    public Page getPageWithSpace(short requiredSpace) {
        ...
        // Acquire Lock
        LockContext pageContext = this.lockContext.childContext(page.getPageNum());
        ...
        private Page loadPageWithSpace(short requiredSpace) {
            ...
            try {
                ...
                if (unusedSlot != -1) {
                    ...
                    // Update capacity
                    int currCapacity = PageDirectory.this.lockContext.capacity();
                    PageDirectory.this.lockContext.capacity(currCapacity + 1);
