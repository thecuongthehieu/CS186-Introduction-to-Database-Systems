...
public class Database implements AutoCloseable {
    ...
    void lockTableMetadata(String tableName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockContext tableContext = getTableContext(tableInfo.getName());
        ...
        LockContext rowContext = getTableContext(tableInfo.getName()).childContext(rid.getPageNum());
        LockUtil.ensureSufficientLockHeld(rowContext, lockType);
    }
    ...
    void lockIndexMetadata(String indexName, LockType lockType) {
        ...
        if (mayNeedToCreate) {
            ...
            LockContext tableContext = getTableContext(indexInfo.getName());
            LockUtil.ensureSufficientLockHeld(tableContext, LockType.IX);
        ...
        RecordId rid = this.indexInfoLookup.get(indexName);
        LockContext rowContext = getTableContext(indexInfo.getName()).childContext(rid.getPageNum());
        LockUtil.ensureSufficientLockHeld(rowContext, lockType);
    }
    ...
    private class TransactionContextImpl extends AbstractTransactionContext {
        ...
        public Iterator<Record> sortedScan(String tableName, String columnName) {
            ...
            LockContext tableContext = Database.this.getTableContext(tableName);
        ...
        public Table getTable(String tableName) {
            ...
            // TODO(proj4_part3): add locking
            ////////////////////////////////////////////////
            Database.this.lockTableMetadata(tableName, LockType.NL);
    ...
    private class TransactionImpl extends AbstractTransaction {
        ...
        public void dropIndex(String tableName, String columnName) {
            ...
            try {
                ...
                LockUtil.ensureSufficientLockHeld(indexContext, LockType.X);
